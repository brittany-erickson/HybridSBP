...
let
  ...
  N1 = N0 = 13
  lvl = 3 # Refinement
  base_name = "stat_mesh_$(lvl)"
  base_name = "stat_V1_$(lvl)"
  =#
  ...
  base_name = "stat_V0_$(SBPp)_skew_$(lvl)"
  =#
