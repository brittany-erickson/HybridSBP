...
let
  ...
  (verts, EToV, EToF, FToB) = read_inp_2d("meshes/fracture_network.inp")
  ...
  @plotting let
    ...
    png(plot(p1, p2, layout = (2,1), size = (2500, 1500)), "fractures")
  end
  nothing
end
